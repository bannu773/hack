...
const App = () => {
  ...
  return (
    <div className='bg-black' >
      ...
      <Land homeref={homeref} aboutRef={aboutRef} themesRef={themesRef} timelineRef={timelineRef} chiefguestsRef={chiefguestsRef} sponsorsRef={sponsorsRef} faqsRef={faqsRef} teamRef={teamRef} />
    </div>
  );
};
